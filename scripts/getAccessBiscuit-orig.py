...
public_key_raw = ask_user_input("Enter the public key (get from the api, for instance: https://theoriq-backend.dev-02.lab.chainml.net/api/v1alpha2/auth/biscuits/public-key)", "0x3363f11284bc2671356a847312dfe4e323f8e82e2032fe69e7e079ff3d1c86bf")
...
expiry_timestamp = ask_user_input("Enter the expiry timestamp (in seconds)", int(datetime.now(timezone.utc).timestamp()) + 3600)
